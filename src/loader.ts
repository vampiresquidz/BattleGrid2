...
export const ALL_SPRITES: string[] = [
  ...
  '/sprites/world_citysign.png',
  '/sprites/world_citylamp.png',
  '/sprites/world_dumpster.png',
  '/sprites/world_vent.png',
  '/sprites/world_terminal.png',
  '/sprites/ally_vendordroid.png',
  '/sprites/ally_fixerbot.png',
